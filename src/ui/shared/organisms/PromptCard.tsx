...
export const PromptCard: React.FC<PromptCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-base-200/20 via-base-100/10 to-base-200/5 backdrop-blur-sm border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300 group w-full">
