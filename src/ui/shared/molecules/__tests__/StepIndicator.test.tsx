...
describe("StepIndicator", () => {
  ...
  it("hides connectors when showConnectors is false", () => {
    ...
    const connectors = screen.queryAllByText("", {
      selector: '[aria-hidden="true"]',
    });
  ...
  it("applies correct spacing classes", () => {
    render(
      <StepIndicator steps={mockSteps} currentStep="step1" spacing="compact" />
    );
  ...
  it("applies relaxed spacing when specified", () => {
    render(
      <StepIndicator steps={mockSteps} currentStep="step1" spacing="relaxed" />
    );
