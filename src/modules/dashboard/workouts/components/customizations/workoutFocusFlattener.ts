...
export function flattenWorkoutFocusData(
  data: WorkoutFocusConfigurationData | string | undefined
): EnhancedWorkoutFocusFlat {
...
function flattenModernWorkoutFocus(
  data: WorkoutFocusConfigurationData
): EnhancedWorkoutFocusFlat {
  // Validate input data
  ...
  if (data.format && isWorkoutFormatValue(data.format)) {
    switch (data.format) {
      // Strength Training Formats
      case 'straight_sets':
        result.format_straight_sets = true;
        break;
      case 'pyramid_sets':
        result.format_pyramid_sets = true;
        break;
      case 'cluster_sets':
        result.format_cluster_sets = true;
        break;
      case 'rest_pause':
        result.format_rest_pause = true;
        break;

      // Powerlifting Formats
      case 'competition_style':
        result.format_competition_style = true;
        break;
      case 'block_periodization':
        result.format_block_periodization = true;
        break;
      case 'conjugate_method':
        result.format_conjugate_method = true;
        break;

      // Strength-Hypertrophy Formats
      case 'heavy_light':
        result.format_heavy_light = true;
        break;
      case 'dup':
        result.format_dup = true;
        break;
      case 'push_pull_legs':
        result.format_push_pull_legs = true;
        break;

      // Muscle Building Formats
      case 'straight_sets_hypertrophy':
        result.format_straight_sets_hypertrophy = true;
        break;
      case 'supersets':
        result.format_supersets = true;
        break;
      case 'drop_sets':
        result.format_drop_sets = true;
        break;
      case 'giant_sets':
        result.format_giant_sets = true;
        break;

      // Bodyweight Building Formats
      case 'progressive_overload':
        result.format_progressive_overload = true;
        break;
      case 'time_under_tension':
        result.format_time_under_tension = true;
        break;
      case 'isometric_holds':
        result.format_isometric_holds = true;
        break;

      // HIIT Formats
      case 'tabata':
        result.format_tabata = true;
        break;
      case 'emom':
        result.format_emom = true;
        break;
      case 'circuit_training':
        result.format_circuit_training = true;
        break;
      case 'sprint_intervals':
        result.format_sprint_intervals = true;
        break;

      // Cardio Endurance Formats
      case 'steady_state':
        result.format_steady_state = true;
        break;
      case 'tempo_intervals':
        result.format_tempo_intervals = true;
        break;
      case 'fartlek':
        result.format_fartlek = true;
        break;

      // Fat Loss Formats
      case 'metabolic_circuits':
        result.format_metabolic_circuits = true;
        break;
      case 'cardio_strength_fusion':
        result.format_cardio_strength_fusion = true;
        break;
      case 'liss_resistance':
        result.format_liss_resistance = true;
        break;

      // Functional Fitness Formats
      case 'movement_patterns':
        result.format_movement_patterns = true;
        break;
      case 'sport_specific':
        result.format_sport_specific = true;
        break;
      case 'crossfit_style':
        result.format_crossfit_style = true;
        break;

      // Flexibility/Mobility Formats
      case 'dynamic_stretching':
        result.format_dynamic_stretching = true;
        break;
      case 'static_stretching':
        result.format_static_stretching = true;
        break;
      case 'pnf_stretching':
        result.format_pnf_stretching = true;
        break;
      case 'yoga_flow':
        result.format_yoga_flow = true;
        break;

      // Recovery/Stretching Formats
      case 'gentle_flow':
        result.format_gentle_flow = true;
        break;
      case 'foam_rolling':
        result.format_foam_rolling = true;
        break;
      case 'breathwork':
        result.format_breathwork = true;
        break;
    }
  }
  ...
  if (data.metadata) {
    ...
    switch (data.metadata.intensity) {
      case 'low':
        result.intensity_low = true;
        break;
      case 'moderate':
        result.intensity_moderate = true;
        break;
      case 'high':
        result.intensity_high = true;
        break;
      case 'variable':
        result.intensity_variable = true;
        break;
    }
    ...
    switch (data.metadata.equipment) {
      case 'minimal':
        result.equipment_minimal = true;
        break;
      case 'moderate':
        result.equipment_moderate = true;
        break;
      case 'full-gym':
        result.equipment_full_gym = true;
        break;
    }
    ...
    switch (data.metadata.experience) {
      case 'all-levels':
        ...
        break;
      case 'intermediate':
        result.experience_intermediate = true;
        break;
      case 'advanced':
        result.experience_advanced = true;
        break;
    }
    ...
    if (data.metadata.duration_compatibility) {
      data.metadata.duration_compatibility.forEach((duration) => {
        switch (duration) {
          case 15:
            result.duration_compatible_15min = true;
            break;
          case 20:
            result.duration_compatible_20min = true;
            break;
          case 30:
            result.duration_compatible_30min = true;
            break;
          ...
          case 60:
            ...
            break;
          case 90:
            result.duration_compatible_90min = true;
            break;
          case 120:
            result.duration_compatible_120min = true;
            break;
        }
      });
    }
...
export function getWorkoutFocusSummary(
  flattened: EnhancedWorkoutFocusFlat
): string {
  const parts = [];

  // Focus type
  const focusTypes = [];
  if (flattened.focus_type_strength_training)
    focusTypes.push('Strength Training');
  ...
  if (flattened.focus_type_cardio_endurance)
    focusTypes.push('Cardio Endurance');
  if (flattened.focus_type_fat_loss) focusTypes.push('Fat Loss');
  if (flattened.focus_type_functional_fitness)
    focusTypes.push('Functional Fitness');
  if (flattened.focus_type_flexibility_mobility)
    focusTypes.push('Flexibility/Mobility');
  if (flattened.focus_type_recovery_stretching)
    focusTypes.push('Recovery/Stretching');
  ...
  if (flattened.focus_beginner_suitability >= 80)
