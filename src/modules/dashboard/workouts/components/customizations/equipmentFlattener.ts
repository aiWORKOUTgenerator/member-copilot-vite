...
export function flattenEquipmentData(
  data: EquipmentSelectionData | string[] | undefined
): EnhancedEquipmentFlat {
...
function flattenLegacyEquipment(data: string[]): EnhancedEquipmentFlat {
  ...
  data.forEach((item) => {
    ...
    if (itemLower.includes('dumbbell'))
      result.equipment_has_dumbbells_specific = true;
    if (itemLower.includes('barbell')) result.equipment_has_barbells = true;
    if (itemLower.includes('kettlebell'))
      result.equipment_has_kettlebells = true;
    if (itemLower.includes('treadmill')) result.equipment_has_treadmill = true;
    if (itemLower.includes('elliptical'))
      result.equipment_has_elliptical = true;
    if (itemLower.includes('bike')) result.equipment_has_stationary_bike = true;
    if (itemLower.includes('yoga_mat') || itemLower.includes('mat'))
      result.equipment_has_yoga_mat = true;
    if (itemLower.includes('pull_up') || itemLower.includes('pullup'))
      result.equipment_has_pull_up_bar = true;
  });

  // Set context flags based on equipment
  if (
    result.equipment_has_dumbbells_specific ||
    result.equipment_has_barbells ||
    result.equipment_has_kettlebells
  ) {
    result.equipment_has_free_weights = true;
  }
  if (
    result.equipment_has_treadmill ||
    result.equipment_has_elliptical ||
    result.equipment_has_stationary_bike
  ) {
...
function flattenModernEquipment(
  ...
  contexts.forEach((context) => {
    switch (context) {
      case 'Free Weights':
        result.equipment_has_free_weights = true;
        break;
      case 'Resistance Machines':
        result.equipment_has_resistance_machines = true;
        break;
      case 'Cable Systems':
        result.equipment_has_cable_systems = true;
        break;
      case 'Smith Machine':
        result.equipment_has_smith_machine = true;
        break;
      case 'Racks & Rigs':
        result.equipment_has_racks_rigs = true;
        break;
      case 'Bodyweight':
        result.equipment_has_bodyweight = true;
        break;
      case 'Resistance Bands':
        result.equipment_has_resistance_bands = true;
        break;
      case 'Basic Cardio':
        result.equipment_has_basic_cardio = true;
        break;
      case 'Advanced Cardio':
        result.equipment_has_advanced_cardio = true;
        break;
      case 'Minimal Cardio':
        result.equipment_has_minimal_cardio = true;
        break;
      case 'Cardio Machines':
        result.equipment_has_cardio_machines = true;
        break;
      case 'Mobility & Recovery':
        result.equipment_has_mobility_recovery = true;
        break;
      case 'Mobility & Stretching':
        result.equipment_has_mobility_stretching = true;
        break;
      case 'Functional Equipment':
        result.equipment_has_functional_equipment = true;
        break;
      case 'Functional Tools':
        result.equipment_has_functional_tools = true;
        break;
      case 'Light Weights':
        result.equipment_has_light_weights = true;
        break;
      case 'Adjustable Dumbbells':
        result.equipment_has_adjustable_dumbbells = true;
        break;
      case 'Mat Work':
        result.equipment_has_mat_work = true;
        break;
      case 'Mat-Based Work':
        result.equipment_has_mat_based_work = true;
        break;
      case 'Resistance Tubes':
        result.equipment_has_resistance_tubes = true;
        break;
      case 'Suspension Trainers':
        result.equipment_has_suspension_trainers = true;
        break;
      case 'Sandbags':
        result.equipment_has_sandbags = true;
        break;
      case 'Jump Rope':
        result.equipment_has_jump_rope = true;
        break;
      case 'Machines':
        result.equipment_has_machines = true;
        break;
      case 'Cable Stations':
        result.equipment_has_cable_stations = true;
        break;
      case 'Dumbbells':
        result.equipment_has_dumbbells = true;
        break;
      case 'Stretch Area':
        result.equipment_has_stretch_area = true;
        break;
      case 'Cardio':
        result.equipment_has_cardio = true;
        break;
      case 'Olympic Lifting':
        result.equipment_has_olympic_lifting = true;
        break;
      case 'Conditioning Tools':
        result.equipment_has_conditioning_tools = true;
        break;
      case 'Athletic Accessories':
        result.equipment_has_athletic_accessories = true;
        break;
      case 'Sport-Specific':
        result.equipment_has_sport_specific = true;
        break;
    }
  });
  ...
  equipment.forEach((item) => {
    switch (item) {
      case 'dumbbells':
        ...
        break;
      case 'barbells':
        result.equipment_has_barbells = true;
        break;
      case 'kettlebells':
        result.equipment_has_kettlebells = true;
        break;
      case 'plates':
        result.equipment_has_plates = true;
        break;
      case 'ez_curl_bar':
        result.equipment_has_ez_curl_bar = true;
        break;
      case 'trap_bar':
        result.equipment_has_trap_bar = true;
        break;
      case 'adjustable_dumbbells':
        result.equipment_has_adjustable_dumbbells_specific = true;
        break;
      case 'squat_rack':
        result.equipment_has_squat_rack = true;
        break;
      case 'smith_machine':
        result.equipment_has_smith_machine_specific = true;
        break;
      case 'pull_up_bar':
        result.equipment_has_pull_up_bar = true;
        break;
      case 'dip_station':
        result.equipment_has_dip_station = true;
        break;
      case 'safety_arms':
        result.equipment_has_safety_arms = true;
        break;
      case 'landmine':
        result.equipment_has_landmine = true;
        break;
      case 'functional_trainer':
        result.equipment_has_functional_trainer = true;
        break;
      case 'lat_pulldown':
        result.equipment_has_lat_pulldown = true;
        break;
      case 'low_row':
        result.equipment_has_low_row = true;
        break;
      case 'cable_column':
        result.equipment_has_cable_column = true;
        break;
      case 'cable_attachments':
        result.equipment_has_cable_attachments = true;
        break;
      case 'mini_bands':
        result.equipment_has_mini_bands = true;
        break;
      case 'loop_bands':
        result.equipment_has_loop_bands = true;
        break;
      case 'resistance_tubes':
        result.equipment_has_resistance_tubes_specific = true;
        break;
      case 'figure_8_bands':
        result.equipment_has_figure_8_bands = true;
        break;
      case 'door_anchor':
        result.equipment_has_door_anchor = true;
        break;
      case 'chest_press':
        result.equipment_has_chest_press = true;
        break;
      case 'leg_press':
        result.equipment_has_leg_press = true;
        break;
      case 'leg_curl':
        result.equipment_has_leg_curl = true;
        break;
      case 'pec_deck':
        result.equipment_has_pec_deck = true;
        break;
      case 'seated_row':
        result.equipment_has_seated_row = true;
        break;
      case 'shoulder_press':
        result.equipment_has_shoulder_press = true;
        break;
      case 'treadmill':
        result.equipment_has_treadmill = true;
        break;
      case 'stationary_bike':
        result.equipment_has_stationary_bike = true;
        break;
      case 'elliptical':
        result.equipment_has_elliptical = true;
        break;
      case 'rowing_machine':
        result.equipment_has_rowing_machine = true;
        break;
      case 'stair_climber':
        result.equipment_has_stair_climber = true;
        break;
      case 'assault_bike':
        result.equipment_has_assault_bike = true;
        break;
      case 'jump_rope':
        result.equipment_has_jump_rope_specific = true;
        break;
      case 'step_stool':
        result.equipment_has_step_stool = true;
        break;
      case 'yoga_mat':
        result.equipment_has_yoga_mat = true;
        break;
      case 'foam_roller':
        result.equipment_has_foam_roller = true;
        break;
      case 'massage_ball':
        result.equipment_has_massage_ball = true;
        break;
      case 'stability_ball':
        result.equipment_has_stability_ball = true;
        break;
      case 'stretching_strap':
        result.equipment_has_stretching_strap = true;
        break;
      case 'medicine_ball':
        result.equipment_has_medicine_ball = true;
        break;
      case 'battle_ropes':
        result.equipment_has_battle_ropes = true;
        break;
      case 'plyo_box':
        result.equipment_has_plyo_box = true;
        break;
      case 'parallettes':
        result.equipment_has_parallettes = true;
        break;
      case 'weighted_vest':
        result.equipment_has_weighted_vest = true;
        break;
      case 'agility_ladder':
        result.equipment_has_agility_ladder = true;
        break;
      case 'sandbag':
        result.equipment_has_sandbag = true;
        break;
      case 'bulgarian_bag':
        result.equipment_has_bulgarian_bag = true;
        break;
      case 'trx':
        result.equipment_has_trx = true;
        break;
      case 'suspension_trainer':
        result.equipment_has_suspension_trainer = true;
        break;
      case 'olympic_barbell':
        result.equipment_has_olympic_barbell = true;
        break;
      case 'bumper_plates':
        result.equipment_has_bumper_plates = true;
        break;
      case 'lifting_platform':
        result.equipment_has_lifting_platform = true;
        break;
      case 'jerk_blocks':
        result.equipment_has_jerk_blocks = true;
        break;
      case 'sled':
        result.equipment_has_sled = true;
        break;
      case 'tire':
        result.equipment_has_tire = true;
        break;
      case 'cones':
        result.equipment_has_cones = true;
        break;
      case 'hurdles':
        result.equipment_has_hurdles = true;
        break;
      case 'parachute':
        result.equipment_has_parachute = true;
        break;
    }
  });
  ...
  weightTypes.forEach((type) => {
    ...
    switch (type) {
      case 'dumbbells':
        result.equipment_dumbbells_min_weight = typeWeights.length
          ? Math.min(...typeWeights)
          : null;
        result.equipment_dumbbells_max_weight = typeWeights.length
          ? Math.max(...typeWeights)
          : null;
        result.equipment_dumbbells_weight_count = typeWeights.length;
        result.equipment_dumbbells_has_light = typeWeights.some((w) => w < 20);
        result.equipment_dumbbells_has_medium = typeWeights.some(
          (w) => w >= 20 && w <= 50
        );
        result.equipment_dumbbells_has_heavy = typeWeights.some((w) => w > 50);
        break;
      case 'barbells':
        result.equipment_barbells_min_weight = typeWeights.length
          ? Math.min(...typeWeights)
          : null;
        result.equipment_barbells_max_weight = typeWeights.length
          ? Math.max(...typeWeights)
          : null;
        ...
        break;
      case 'kettlebells':
        result.equipment_kettlebells_min_weight = typeWeights.length
          ? Math.min(...typeWeights)
          : null;
        result.equipment_kettlebells_max_weight = typeWeights.length
          ? Math.max(...typeWeights)
          : null;
        result.equipment_kettlebells_weight_count = typeWeights.length;
        result.equipment_kettlebells_has_light = typeWeights.some(
          (w) => w < 16
        );
        result.equipment_kettlebells_has_medium = typeWeights.some(
          (w) => w >= 16 && w <= 32
        );
        result.equipment_kettlebells_has_heavy = typeWeights.some(
          (w) => w > 32
        );
        break;
      case 'plates':
        result.equipment_plates_min_weight = typeWeights.length
          ? Math.min(...typeWeights)
          : null;
        result.equipment_plates_max_weight = typeWeights.length
          ? Math.max(...typeWeights)
          : null;
        result.equipment_plates_weight_count = typeWeights.length;
        break;
      case 'adjustable_dumbbells':
        result.equipment_adjustable_dumbbells_min_weight = typeWeights.length
          ? Math.min(...typeWeights)
          : null;
        result.equipment_adjustable_dumbbells_max_weight = typeWeights.length
          ? Math.max(...typeWeights)
          : null;
  ...
  result.equipment_overall_min_weight = allWeights.length
    ? Math.min(...allWeights)
    : null;
  result.equipment_overall_max_weight = allWeights.length
    ? Math.max(...allWeights)
    : null;
  ...
  result.equipment_functional_capability =
    calculateFunctionalCapability(result);

  result.equipment_data_json = JSON.stringify(data);
  result.equipment_last_updated = data.lastUpdated
...
function calculateVersatilityScore(result: EnhancedEquipmentFlat): number {
  ...
  const contextFlags = [
    result.equipment_has_free_weights,
    result.equipment_has_resistance_machines,
    result.equipment_has_cable_systems,
    result.equipment_has_bodyweight,
    result.equipment_has_basic_cardio,
    result.equipment_has_advanced_cardio,
    result.equipment_has_functional_equipment,
    result.equipment_has_mobility_recovery,
  ];
...
export function getEquipmentSummary(flattened: EnhancedEquipmentFlat): string {
  ...
  if (
    flattened.equipment_overall_min_weight &&
    flattened.equipment_overall_max_weight
  ) {
    parts.push(
      `Weights: ${flattened.equipment_overall_min_weight}-${flattened.equipment_overall_max_weight} lbs`
    );
  }

  if (flattened.equipment_has_free_weights) parts.push('Free Weights');
  if (
    flattened.equipment_has_basic_cardio ||
    flattened.equipment_has_advanced_cardio
  )
    parts.push('Cardio');
