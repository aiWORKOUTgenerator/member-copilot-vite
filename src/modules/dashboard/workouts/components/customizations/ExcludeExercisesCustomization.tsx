...
export default memo(function ExcludeExercisesCustomization({
  ...
  const createExcludeData = useCallback(
    (customText: string, libraryList: string[]): ExcludeExercisesData => ({
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-warning/10 rounded-lg border border-warning/20">
        ...
        <div className="space-y-1 text-warning text-sm">
          <p>
            <strong>Custom Exclusions:</strong> Type exercises you want to avoid
            (comma-separated)
          </p>
          <p>
            <strong>Exercise Library:</strong> Browse and exclude common risky
