...
export function flattenFocusAreaData(data: HierarchicalSelectionData | string[] | undefined): EnhancedFocusAreaFlat {
...
function flattenLegacyFocusAreas(areas: string[]): EnhancedFocusAreaFlat {
  ...
  areas.forEach(area => {
    switch (area) {
      // Primary regions
      case 'upper_body': result.focus_region_upper_body = true; break;
      case 'lower_body': result.focus_region_lower_body = true; break;
      case 'core': result.focus_region_core = true; break;
      case 'full_body': result.focus_region_full_body = true; break;
      case 'mobility': result.focus_region_mobility = true; break;
      case 'recovery': result.focus_region_recovery = true; break;
      
      // Upper body muscles
      case 'chest': result.focus_upper_chest = true; break;
      case 'back': result.focus_upper_back = true; break;
      case 'shoulders': result.focus_upper_shoulders = true; break;
      case 'biceps': result.focus_upper_biceps = true; break;
      case 'triceps': result.focus_upper_triceps = true; break;
      
      // Lower body muscles
      case 'quads': result.focus_lower_quads = true; break;
      case 'hamstrings': result.focus_lower_hamstrings = true; break;
      case 'glutes': result.focus_lower_glutes = true; break;
      case 'calves': result.focus_lower_calves = true; break;
      
      // Core muscles
      case 'abs': result.focus_core_abs = true; break;
      case 'obliques': result.focus_core_obliques = true; break;
      case 'lower_back': result.focus_core_lower_back = true; break;
      
      // Full body types
      case 'olympic_lifts': result.focus_fullbody_olympic_lifts = true; break;
      case 'bodyweight_circuits': result.focus_fullbody_bodyweight_circuits = true; break;
      case 'athletic_conditioning': result.focus_fullbody_athletic_conditioning = true; break;
      
      // Mobility areas
      case 'hips': result.focus_mobility_hips = true; break;
      case 'ankles': result.focus_mobility_ankles = true; break;
      case 'mobility_shoulders': result.focus_mobility_shoulders = true; break;
      case 'thoracic_spine': result.focus_mobility_thoracic_spine = true; break;
      
      // Recovery types
      case 'foam_rolling': result.focus_recovery_foam_rolling = true; break;
      case 'static_stretching': result.focus_recovery_static_stretching = true; break;
      case 'pnf': result.focus_recovery_pnf = true; break;
      case 'breathing_meditation': result.focus_recovery_breathing_meditation = true; break;
      
      // Specific areas (tertiary level)
      case 'upper_chest': result.focus_chest_upper = true; break;
      case 'lower_chest': result.focus_chest_lower = true; break;
      case 'lats': result.focus_back_lats = true; break;
      case 'traps': result.focus_back_traps = true; break;
      case 'rhomboids': result.focus_back_rhomboids = true; break;
      case 'erector_spinae': result.focus_back_erector_spinae = true; break;
      case 'anterior_delt': result.focus_shoulder_anterior_delt = true; break;
      case 'lateral_delt': result.focus_shoulder_lateral_delt = true; break;
      case 'rear_delt': result.focus_shoulder_rear_delt = true; break;
  ...
  result.focus_has_upper_body = result.focus_region_upper_body || result.focus_upper_chest || result.focus_upper_back || result.focus_upper_shoulders || result.focus_upper_biceps || result.focus_upper_triceps;
  result.focus_has_lower_body = result.focus_region_lower_body || result.focus_lower_quads || result.focus_lower_hamstrings || result.focus_lower_glutes || result.focus_lower_calves;
  result.focus_has_core = result.focus_region_core || result.focus_core_abs || result.focus_core_obliques || result.focus_core_lower_back;
  result.focus_has_full_body = result.focus_region_full_body || result.focus_fullbody_olympic_lifts || result.focus_fullbody_bodyweight_circuits || result.focus_fullbody_athletic_conditioning;
  result.focus_has_mobility = result.focus_region_mobility || result.focus_mobility_hips || result.focus_mobility_ankles || result.focus_mobility_shoulders || result.focus_mobility_thoracic_spine;
  result.focus_has_recovery = result.focus_region_recovery || result.focus_recovery_foam_rolling || result.focus_recovery_static_stretching || result.focus_recovery_pnf || result.focus_recovery_breathing_meditation;
  
  result.focus_is_balanced_selection = (result.focus_has_upper_body && result.focus_has_lower_body) || result.focus_has_full_body;
  ...
  result.focus_suitable_strength = result.focus_has_upper_body || result.focus_has_lower_body || result.focus_has_full_body;
  result.focus_suitable_hypertrophy = result.focus_has_upper_body || result.focus_has_lower_body;
  result.focus_suitable_flexibility = result.focus_has_mobility || result.focus_has_recovery;
  result.focus_suitable_athletic = result.focus_has_full_body || result.focus_fullbody_athletic_conditioning;
...
function flattenModernFocusAreas(data: HierarchicalSelectionData): EnhancedFocusAreaFlat {
  const result = createEmptyFocusAreaFlattened();
  ...
  Object.entries(data).forEach(([key, info]) => {
    ...
    switch (key) {
      ...
      // Arm specific
      case 'biceps_short_head': result.focus_biceps_short_head = true; break;
      case 'biceps_long_head': result.focus_biceps_long_head = true; break;
      case 'brachialis': result.focus_biceps_brachialis = true; break;
      case 'triceps_long_head': result.focus_triceps_long_head = true; break;
      case 'triceps_lateral_head': result.focus_triceps_lateral_head = true; break;
      case 'triceps_medial_head': result.focus_triceps_medial_head = true; break;
      
      // Leg specific
      case 'rectus_femoris': result.focus_quad_rectus_femoris = true; break;
      case 'vastus_lateralis': result.focus_quad_vastus_lateralis = true; break;
      case 'vastus_medialis': result.focus_quad_vastus_medialis = true; break;
      case 'vastus_intermedius': result.focus_quad_vastus_intermedius = true; break;
      case 'glute_max': result.focus_glute_max = true; break;
      case 'glute_med': result.focus_glute_med = true; break;
      case 'glute_min': result.focus_glute_min = true; break;
      case 'biceps_femoris': result.focus_hamstring_biceps_femoris = true; break;
      case 'semitendinosus': result.focus_hamstring_semitendinosus = true; break;
      case 'semimembranosus': result.focus_hamstring_semimembranosus = true; break;
      case 'gastrocnemius_medial': result.focus_calf_gastrocnemius_medial = true; break;
      case 'gastrocnemius_lateral': result.focus_calf_gastrocnemius_lateral = true; break;
      case 'soleus': result.focus_calf_soleus = true; break;
      
      // Core specific
      case 'upper_abs': result.focus_abs_upper = true; break;
      case 'lower_abs': result.focus_abs_lower = true; break;
      case 'tva': result.focus_abs_tva = true; break;
      case 'pelvic_floor': result.focus_abs_pelvic_floor = true; break;
      case 'internal_obliques': result.focus_oblique_internal = true; break;
      case 'external_obliques': result.focus_oblique_external = true; break;
      case 'lower_erector_spinae': result.focus_lowerback_erector_spinae = true; break;
      case 'multifidus': result.focus_lowerback_multifidus = true; break;
      case 'quadratus_lumborum': result.focus_lowerback_quadratus_lumborum = true; break;
      
      // Mobility specific
      case 'hip_flexors': result.focus_hip_flexors = true; break;
      case 'hip_glute_med': result.focus_hip_glute_med = true; break;
      case 'tfl': result.focus_hip_tfl = true; break;
      case 'piriformis': result.focus_hip_piriformis = true; break;
      case 'dorsiflexors': result.focus_ankle_dorsiflexors = true; break;
      case 'plantarflexors': result.focus_ankle_plantarflexors = true; break;
      case 'inverters': result.focus_ankle_inverters = true; break;
      case 'everters': result.focus_ankle_everters = true; break;
      case 'subscapularis': result.focus_shoulder_subscapularis = true; break;
      case 'supraspinatus': result.focus_shoulder_supraspinatus = true; break;
      case 'infraspinatus': result.focus_shoulder_infraspinatus = true; break;
      case 'teres_minor': result.focus_shoulder_teres_minor = true; break;
    }
  ...
  // Calculate analytics
  result.focus_selection_count = Object.values(data).filter(info => info.selected).length;
  ...
  result.focus_suitable_strength = result.focus_has_upper_body || result.focus_has_lower_body || result.focus_has_full_body;
  result.focus_suitable_hypertrophy = result.focus_has_upper_body || result.focus_has_lower_body;
  result.focus_suitable_endurance = result.focus_has_full_body || result.focus_fullbody_bodyweight_circuits;
  result.focus_suitable_power = result.focus_fullbody_olympic_lifts || result.focus_fullbody_athletic_conditioning;
  result.focus_suitable_rehabilitation = result.focus_has_mobility || result.focus_has_recovery;
  result.focus_suitable_flexibility = result.focus_has_mobility || result.focus_has_recovery;
  result.focus_suitable_athletic = result.focus_has_full_body || result.focus_fullbody_athletic_conditioning;
  
  // Training split compatibility
  result.focus_compatible_push_pull = result.focus_has_upper_body && (result.focus_upper_chest || result.focus_upper_shoulders || result.focus_upper_triceps || result.focus_upper_back || result.focus_upper_biceps);
  result.focus_compatible_upper_lower = result.focus_has_upper_body && result.focus_has_lower_body;
  result.focus_compatible_body_part_split = result.focus_selection_count <= 3 && !result.focus_has_full_body;
  result.focus_compatible_full_body = result.focus_has_full_body || result.focus_is_balanced_selection;
  result.focus_compatible_functional = result.focus_has_full_body || result.focus_has_mobility || result.focus_fullbody_athletic_conditioning;
...
function calculateIntensityCapacity(result: EnhancedFocusAreaFlat): number {
  ...
  if (result.focus_lower_quads || result.focus_lower_glutes || result.focus_lower_hamstrings) score += 25;
  ...
  if (result.focus_has_mobility && !result.focus_has_upper_body && !result.focus_has_lower_body) score -= 15;
...
function calculateRecoveryDemand(result: EnhancedFocusAreaFlat): number {
  ...
  if (result.focus_lower_quads && result.focus_lower_glutes && result.focus_lower_hamstrings) score += 20;
...
function calculateTechnicalComplexity(result: EnhancedFocusAreaFlat): number {
  ...
  if (result.focus_is_targeted_selection && !result.focus_has_full_body) score -= 10;
